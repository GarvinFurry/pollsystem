      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-8 text-center" id="user-section">
              <img class="cover-img" src="img/OMEN Aero.png">
                    ...
                    else
                    {
                        ...
                        if(empty($row))
                        {
                            echo '<div class="col-sm-4" style="padding-bottom: 30px;"></div>
                                <div class="col-sm-4">
                                    <img class="profile-empty-img" src="img/OMEN Aero.png">
                                  </div>
                            ...
                            do
                            {
                                echo '<div class="col-sm-4" style="padding-bottom: 30px;">
                                        <div class="card user-blogs">
                                            ...
                                            <img class="card-img-top" src="img/OMEN Aero.png" alt="Card image cap">
                                            <div class="card-block p-2">
